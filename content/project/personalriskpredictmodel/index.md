...
![前车突然减速](前车减速.png "前车突然减速")![侧向车辆加入](侧向车辆加入.png "侧向车辆加入")

通过修改上述参数，我们得到共35个模拟风险场景。结合已有研究成果和本次实验设计，选取对风险排序的判断依据如表1所示。对比模拟实验中车辆纵向加速度曲线与驾驶员实际给出的风险排序（见图6），发现二者契合程度较高，表明通过驾驶行为得到个体风险排序具有可行性。
...
![分级消融实验验证](分级排序消融.png "分级消融实验")![双目标更新消融实验验证](双目标更新消融.png "双目标更新消融实验")![约束项消融实验验证](约束项消融.png "约束项消融实验")
...
#### Acknowledge
*感谢余荣杰老师的指导与对项目的建议；感谢谢宁学长对我们每个难题的细致讲解、对我每次迷茫的耐心解惑；感谢组长和两位组员的付出与帮助，让我在这次项目中不仅收获到专业技能的提高，还感受到彼此信任的可贵。*
